...
Если ответ короткий и простой — отвечай обычным текстом без списков.
Если ответ содержит несколько условий, шагов или уточняющих пунктов — структурируй его короткими абзацами и маркированным списком.
Не используй Markdown, HTML-разметку и эмодзи.`;
